package com.bright.commoncode.mapper;
...
import com.bright.commoncode.utils.BeanCopyUtil;
...
public interface MyBaseMapper<M, T, V> extends BaseMapper<T> {
    ...
    default Class<V> currentVoClass() {
        return (Class<V>) ReflectionKit.getSuperClassGenericType(this.getClass(), MyBaseMapper.class, 2);
    }
    ...
    default Class<M> currentMapperClass() {
        return (Class<M>) ReflectionKit.getSuperClassGenericType(this.getClass(), MyBaseMapper.class, 0);
    }
