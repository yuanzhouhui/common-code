package com.bright.commoncode.cache.impl;

import com.bright.commoncode.cache.IGlobalCache;
...
@Getter
@AllArgsConstructor
public class WebRedisCacheManager implements IGlobalCache {
	...
	public String hget(String key, String item) {
		return Objects.isNull(redisTemplate.opsForHash().get(key, item)) ? null : redisTemplate.opsForHash().get(key, item).toString();
	}
